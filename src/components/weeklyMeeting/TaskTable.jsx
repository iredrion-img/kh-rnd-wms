    ...
    return (
      <table className="w-full text-sm text-left schedule-table">
        <thead className="text-xs text-gray-500 uppercase">
          <tr>
            <th className="px-4 py-3 rounded-tl-lg sticky top-0 bg-gray-50 z-10 shadow-[0_1px_0_rgba(200,200,200,0.5)] w-24 whitespace-nowrap">구분</th>
            <th className="px-4 py-3 sticky top-0 bg-gray-50 z-10 shadow-[0_1px_0_rgba(200,200,200,0.5)] w-32 whitespace-nowrap">수행인원</th>
            <th className="px-4 py-3 text-center sticky top-0 bg-gray-50 z-10 shadow-[0_1px_0_rgba(200,200,200,0.5)] w-28 whitespace-nowrap">시작예정</th>
            <th className="px-4 py-3 text-center sticky top-0 bg-gray-50 z-10 shadow-[0_1px_0_rgba(200,200,200,0.5)] w-28 whitespace-nowrap">종료예정</th>
