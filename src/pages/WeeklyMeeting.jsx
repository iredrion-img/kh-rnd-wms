...
const WeeklyMeeting = () => {
    return (
        <div className="p-8 h-full flex flex-col items-center justify-center animate-in fade-in zoom-in-95 duration-500">
            <div className="bg-white p-12 rounded-3xl border border-gray-100 flex flex-col items-center max-w-lg w-full shadow-2xl shadow-gray-200/50 backdrop-blur-sm">
                ...
                <h2 className="text-3xl font-bold text-gray-800 mb-4 tracking-tight">Coming Soon</h2>
                <p className="text-gray-500 text-center mb-8 text-lg font-medium">
                ...
                <p className="text-xs text-primary font-bold font-mono tracking-widest uppercase">Under Construction</p>
            </div>
        </div>
    );
};
