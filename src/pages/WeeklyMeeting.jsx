      ...
      {isFullscreenMode && (
        <div className="fixed inset-0 z-[9999] bg-white flex flex-col is-fullscreen-mode overflow-hidden">
          ...
          <style dangerouslySetInnerHTML={{ __html: `
            ...
            .is-fullscreen-mode .weekly-tasks-table:not(.has-no-meeting-result) th:nth-child(6), .is-fullscreen-mode .weekly-tasks-table:not(.has-no-meeting-result) td:nth-child(6) { width: 12rem !important; } /* 공유회의/결과보고 */
            ...
            .is-fullscreen-mode .schedule-table { table-layout: fixed !important; width: 100% !important; }
            .is-fullscreen-mode .schedule-table th:nth-child(1), .is-fullscreen-mode .schedule-table td:nth-child(1) { width: 8rem !important; } /* 구분 */
            .is-fullscreen-mode .schedule-table th:nth-child(2), .is-fullscreen-mode .schedule-table td:nth-child(2) { width: 12rem !important; } /* 수행인원 */
            ...
            .is-fullscreen-mode .schedule-table th:nth-child(6), .is-fullscreen-mode .schedule-table td:nth-child(6) { width: 17rem !important; } /* 비고 */
